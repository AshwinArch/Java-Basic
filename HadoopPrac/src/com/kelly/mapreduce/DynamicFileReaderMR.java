...
public class DynamicFileReaderMR
{
	...
	public static class ReducerClass extends MapReduceBase implements Reducer<Text, IntWritable, Text, IntWritable>
	{
		...
		{
			int sum = 0; // to sum
			int count = 0 ; // to know what is happening in reducer in this program
	...
	public static void main(String[] args) throws IOException 
	{
		...
		conf.setJarByClass(DynamicFileReaderMR.class);
		conf.setJobName("DynamicFileReaderMR");
...
/* above program meant for reading input data from more than one number of files at one */
/* time and sum the each input file data and display to corresponding file name */