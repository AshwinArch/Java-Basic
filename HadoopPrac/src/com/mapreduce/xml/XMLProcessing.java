...
public static class Reduce
  ...
  public static String constructPropertyXml(Text name, Text value) 
  {
	  ...
	  sb.append("<property><name>").append(name).append("</name><value>").append(value).append("</value></property>");
	  return sb.toString();
  }
}
   ...
   public static void main(String[] args) throws Exception
        {
                ...
                job.setMapperClass(XMLProcessing.Map.class);
                job.setReducerClass(XMLProcessing.Reduce.class);
